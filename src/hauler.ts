...
export function runLogic(creep: prototypes.Creep, idx: number, state: types.State, starterContainers: prototypes.StructureContainer[], mySpawn: prototypes.StructureSpawn) {
